<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TestRedact.ascx.cs" Inherits="TestKnowlige.usercontrol.TestRedact" %>
<div class="UC_main">
<div class="backgr"></div>
    <div class="usercontr">
        ...
        <asp:Button ID="RedactTestName" Text="Редактировать" Visible="false" runat="server" OnClick="RedactTestName_Click" />
